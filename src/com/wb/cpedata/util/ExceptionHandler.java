...
public class ExceptionHandler {
	...
	public static void handleException(final Throwable e, final Activity a) {
		if (e != null && e.getMessage() != null)
			CPEDataParserLogger.d(F.TAG, "ExceptionHandler.handleException: " + (a != null && a.getClass() != null ? a.getClass() + ": " + e.getMessage() : e.getMessage()));
		/*
	...
	public static void logException(Exception e, Class<?> clazz) {
		CPEDataParserLogger.e(F.TAG, clazz.getSimpleName() + " " + e.getMessage(), e);
	}
}
